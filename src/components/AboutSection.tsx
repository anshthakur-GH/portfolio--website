...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="section-padding -mt-16 bg-secondary">
        ...
        <div ref={sectionRef} className={`max-w-5xl mx-auto ${inView ? 'animate-slide-up' : 'opacity-0'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            <div className="lg:col-span-2 flex justify-center">
              <div className="relative w-5/6 sm:w-full max-w-[180px] sm:max-w-full aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-orange-400/20 to-orange-600/20 p-1">
                <img
